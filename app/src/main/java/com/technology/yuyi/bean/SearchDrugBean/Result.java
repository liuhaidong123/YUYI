package com.technology.yuyi.bean.SearchDrugBean;
...
public class Result {
    ...
    private List<String> specificationsdList;
    ...
    public List<String> getSpecificationsdList() {
        return specificationsdList;
    }

    public void setSpecificationsdList(List<String> specificationsdList) {
