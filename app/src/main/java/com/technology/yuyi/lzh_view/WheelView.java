...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.color.transparent_background/*R.drawable.t_user_center_bottom*/;
	private int wheelForeground = R.color.trans2;/*R.drawable.t_user_center_bottom;*/
	...
	public void setViewAdapter(WheelViewAdapter viewAdapter) {
		wheelCurrent= (WheelCurrent) viewAdapter;
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnWheelChangedListener listener : changingListeners) {
			wheelCurrent.sendCurrent(newValue);
	...
	public void setCurrentItem(int index, boolean animated) {
		...
		if (index != currentItem) {
			if (animated) {
				...
				wheelCurrent.sendCurrent(currentItem);
				invalidate();
			}
		}
	}
